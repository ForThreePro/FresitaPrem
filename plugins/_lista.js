...
╰─────────────────❒\n\n`
        ...
        msg += `╰─────────────────❒\n\n`
        msg += `> *“La fresa más dulce del sorteo”* 🍓\n`
        msg += `> *© Fresita Bot*`
    ...
    if(command === 'list'){
        ...
        guardarDB(data)
        return conn.reply(m.chat, `╭─🍓 *『 𝐅𝐑𝐄𝐒𝐈𝐓𝐀 𝐁𝐎𝐓 』* 🍓\n│ ✅ *¡ANOTADO CON ÉXITO!*\n│\n│ 👤 *Nombre:* ${nombre}\n│ 📱 *Número:* ${numero}\n│ 🎁 *Premio:* ${premio}\n│ 📅 *Día:* ${hoy.toUpperCase()}\n│\n│ 🌸 *Suerte fresita*\n╰─────────────────❒`, m)
    }
    ...
    if(command === 'extra'){
        ...
        guardarDB(data)
        return conn.reply(m.chat, `╭─🍓 *『 𝐅𝐑𝐄𝐒𝐈𝐓𝐀 𝐁𝐎𝐓 』* 🍓\n│ 🍰 *ANOTADO EN EXTRA*\n│\n│ 👤 *Nombre:* ${nombre}\n│ 📱 *Número:* ${numero}\n│ 🎁 *Premio:* ${premio}\n│\n│ 🍓 *Premio dulce de la fresita*\n╰─────────────────❒`, m)
    }

    // =====.delall =====
    if(command === 'delall'){
        if(!isAdmin) return conn.reply(m.chat, `╭─🍓 *『 𝐅𝐑𝐄𝐒𝐈𝐓𝐀 𝐁𝐎𝐓 』* 🍓\n│ 🛡️ *ERROR*\n│ Solo *ADMINS* pueden usar esto\n╰─────────────────❒`, m)
